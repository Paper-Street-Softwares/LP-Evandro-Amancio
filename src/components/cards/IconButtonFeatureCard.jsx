export default function IconButtonFeatureCard(props) {
  ...
  return (
    <div
      className={`w-[250px] bg-buttonColor phone2:w-[300px] phone3:w-[350px] tablet1:h-[330px] tablet1:max-w-[255px] desktop1:max-w-[250px] p-0 flex flex-col items-center desktop1:p-0 ${className}`}
    >
      <div
        className={`h-[64px] text-white w-[64px] mb-[24px] rounded-md flex justify-center items-center ${bgClass}`}
      >
        {icon}
      </div>
      <h1
